...
Other R manuals for Psychobiology: file:///C:/Users/Jonas/Documents/GitHub/PB_statisiek/index.html
...
reqPacks = c("markdown","knitr","kableExtra","car","ez","afex")
...
```{r, results='hold'}
data.long$subjMean     = data.long$score
data.long$correction   = data.long$score
data.long$corrected    = data.long$score
